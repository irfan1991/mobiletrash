...
import andara.heatcliff.yuclean.Fragment.KegiatanFragment;
...
public class TabFragment extends Fragment {
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        {
            switch (position){
                case 0 : return new KegiatanFragment();
                case 1 : return new JualBeliFragment();
                case 2 : return new UserProfilFragment();
            }
            return null;
        }
